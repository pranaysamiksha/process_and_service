...
namespace process_pousse.pms_process {
    ...
    public partial class process : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string Addbrowser_history(int user_masterID, string browser_name, string url, string title, string last_visit_time) {
        ...
        /// <remarks/>
        public void Addbrowser_historyAsync(int user_masterID, string browser_name, string url, string title, string last_visit_time) {
            this.Addbrowser_historyAsync(user_masterID, browser_name, url, title, last_visit_time, null);
        }
        
        /// <remarks/>
        public void Addbrowser_historyAsync(int user_masterID, string browser_name, string url, string title, string last_visit_time, object userState) {
            ...
            this.InvokeAsync("Addbrowser_history", new object[] {
                        ...
                        url,
                        title,
                        last_visit_time}, this.Addbrowser_historyOperationCompleted, userState);
        }
