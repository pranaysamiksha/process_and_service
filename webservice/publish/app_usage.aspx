<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="app_usage.aspx.cs" Inherits="process_webservice.app_usage" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">App Monitoring Report</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                ...
                <div class="col-xl-12 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <h5 class="mb-4">App Monitoring Report</h5>
            ...
            <div class="card">
                <div class="table-responsive">
                    <asp:DataGrid ID="dgCountries" GridLines="Vertical" BorderColor="lightgray" Width="100%"
                        ...
                        PageSize="100" AutoGenerateColumns="false"  AllowPaging="true" OnItemDataBound="dgCountries_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <div style="padding: 0px 0px 0px 05px; text-align: left;">
                                        <%#Eval("processName")%>
                                        <asp:HiddenField ID="hfcountr" runat="server" Value='<%#Eval("countr")%>' />
                                    </div>
                                </ItemTemplate>
